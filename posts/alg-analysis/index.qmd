...
This is a tight bound. In other words, the upper and lower bounds are equivalent up to constant factors. 
...
The function $f(n)$ graphed is *strictly above* to algorithm A's graph.
...
The function $f(n)$ graphed is *strictly below* to algorithm A's graph.
